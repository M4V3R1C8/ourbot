...
module.exports = {
  name: "kick",
  description: "Kick lfg players after each raid: Note, you have to give them a new roll if they want to stick around.",
  category: "moderation",
  usage: "<user id> <reason>",
  run: async ( bot, message, args ) => {
    var role = member.guild.roles.cache.find( role => role.name === "non-member" );
